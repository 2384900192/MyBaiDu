...
public class WNaviGuideActivityActivity extends Activity {
...
//获取诱导页面地图展示View
        View view = mNaviHelper.onCreate(WNaviGuideActivityActivity.this);
        if (view != null) {
            setContentView(view);
        }
        //获取语音播报文本
        //该接口需要在startWikeNavi方法之前调用。
        ...
        mNaviHelper.startWalkNavi(WNaviGuideActivityActivity.this);//开始导航
        ...
        mNaviHelper.setWalkNaviStatusListener(new IWNaviStatusListener() {
            ...
            public void onWalkNaviModeChange(int mode, WalkNaviModeSwitchListener walkNaviModeSwitchListener) {
                mNaviHelper.switchWalkNaviMode(WNaviGuideActivityActivity.this, mode, walkNaviModeSwitchListener);
            }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == ArCameraView.WALK_AR_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                mNaviHelper.startCameraAndSetMapView(WNaviGuideActivityActivity.this);
