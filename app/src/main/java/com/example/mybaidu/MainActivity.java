...
//在地图上添加Marker，并显示
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                double aon = position.latitude;
                Toast.makeText(MainActivity.this, "" + lon + "" + aon, Toast.LENGTH_SHORT).show();
                return false;
            }
        });
        //Marker拖拽事件
    ...
    private void initView() {
        ...
        mSouEt = (EditText) findViewById(R.id.et_sou);
        mSeachBtn = (Button) findViewById(R.id.btn_seach);
        mSeachBtn.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bmapView:
                // TODO 20/07/21
                break;
            case R.id.btn_seach:// TODO 20/07/23
                startSeach();//开始检索
                break;
            default:
                break;
    ...
    private void startSeach() {
        String key = mSouEt.getText().toString().trim();
